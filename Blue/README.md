...
Although this is the most efficient solution to the challenge, it can be counter-productive to the process for some, seeing as our aim is to learn as much as we can about the use of Meterpreter, shell and session switching, as well as Windows filesystems. That said, knowing how and when to take advantage of Meterpreter commands is good knowledge in itself.
